...
export default function OverviewTab({ eventId, groups, onGroupsChanged, financialRefreshTrigger }: Props) {
  return (
    <div className="h-full min-h-0 grid grid-cols-4 gap-6">
      ...
      <div className="hidden lg:block lg:col-span-3 min-h-0">
        <EventChart eventId={eventId} financialRefreshTrigger={financialRefreshTrigger} />
      </div>
    </div>
  );
}
